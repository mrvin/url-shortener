...
Приложение должно быть реализовано в виде HTTP сервера, реализующее REST API. Сервер должен реализовывать 8 методов и их логику:
...
### Todo list
- Добавить валидацию alias.
- Eсли alias не найден, то возвращать 404.
- Добавить сортировку для urls.
